...
class ExprDef_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_CSTRING("haxe.macro.ExprDef"); }
		::String __ToString() const { return HX_CSTRING("ExprDef.") + tag; }

		static ::haxe::macro::ExprDef EArray(Dynamic e1,Dynamic e2);
		static Dynamic EArray_dyn();
		static ::haxe::macro::ExprDef EArrayDecl(Dynamic values);
		...
		static ::haxe::macro::ExprDef ENew(Dynamic t,Dynamic params);
		static Dynamic ENew_dyn();
		static ::haxe::macro::ExprDef EObjectDecl(Dynamic fields);
		...
		static ::haxe::macro::ExprDef ESwitch(Dynamic e,Dynamic cases,Dynamic edef);
		...
		static ::haxe::macro::ExprDef ETry(Dynamic e,Dynamic catches);
		...
		static ::haxe::macro::ExprDef EVars(Dynamic vars);
