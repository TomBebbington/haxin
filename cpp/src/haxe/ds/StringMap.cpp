...
{
HX_STACK_PUSH("StringMap::new","haxe/ds/StringMap.hx",28);
{
...
bool StringMap_obj::exists( ::String key){
	HX_STACK_PUSH("StringMap::exists","haxe/ds/StringMap.hx",40);
	HX_STACK_THIS(this);
...
Dynamic StringMap_obj::get( ::String key){
	HX_STACK_PUSH("StringMap::get","haxe/ds/StringMap.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(36)
...
{
		HX_STACK_PUSH("StringMap::set","haxe/ds/StringMap.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
