...
{
HX_STACK_PUSH("FileOutput::new","sys/io/FileOutput.hx",31);
{
	HX_STACK_LINE(31)
	this->__f = f;
}
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_PUSH("FileOutput::writeBytes","sys/io/FileOutput.hx",39);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(p,"p");
	HX_STACK_ARG(l,"l");
...
{
		HX_STACK_PUSH("FileOutput::writeByte","sys/io/FileOutput.hx",35);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(35)
		try{
